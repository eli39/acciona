                ...
                <div class="col-xs-12">
                    <div class="box box-danger">
                        <div class="box-header">
                            <h3 class="box-title"> Bítacora de actividades </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <table id="example" class="display nowrap" style="width:100%">
                                ...
                                <tbody>    
                                    <tr>
                                        <td>África Sofía Alvarez Hernandez</td>
                                        <td>Administrador</td>
                                        <td>Subió archivo 5 minutal</td>
                                        <td>2019-Abr-11 11:11:00 am</td>
                                    </tr>                                
                                    <tr>
